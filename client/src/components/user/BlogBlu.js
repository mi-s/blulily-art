...
const BlogBlu = ({ posts, auth }) => {
   ...
   return (
      <React.Fragment>
         ...
         <section class="jumbotron text-center" style={{background: "rgb(125, 151, 255, .8)"}}>
            <div class="container">
               <h1>
               ...
               <p class="lead">Something short and leading about Brian (Blu). Make it short and sweet, but not too short so folks don’t simply skip over it entirely. Contact information can also go here.</p>
            </div>
         </section>
         ...
         <div style={{background: "rgb(125, 151, 255, .8)"}}>
            <Footer />
         </div>
